...
const Allrooms = () => {
    ...
    const handleSortChange =(sortOption) =>{
        ...
        // Implement sorting logic here based on selectedSort
    ...
    // Function to filter rooms based on selected sort option
    ...
    const filterDestination=(room) => {
        ...
        if(!destination) return true; // If no destination is specified, show all rooms
